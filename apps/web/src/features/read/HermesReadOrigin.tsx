 ...
 *
 */
export type TypesHermesReadOrigin = {
 ...
 *
 */
export const HermesReadOrigin: React.FC<TypesHermesReadOrigin> = ({
  basis,
}: TypesHermesReadOrigin) => {
        ...
        <div className={`flex flex-col w-full max-lg:px-4 px-72 pt-8`}>
          <div className={`flex flex-col w-full`}>
            <div className={`flex flex-row w-full`}>
              <p className={"font-mono font-medium text-md"}>{"Read"}</p>
            </div>
          </div>
        </div>
      </div>
