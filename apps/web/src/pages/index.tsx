import { HermesOrigin } from "@hermes-web-features/_hermes/HermesOrigin";
 ...
 *
 */
const HermesPagesIndex: NextPage = () => {
  ...
  return mounted ? (
    <HermesOrigin basis={{ key: RootShape.basiskey, dictionary: [...BASIS] }} />
  ) : null;
};

export default HermesPagesIndex;
